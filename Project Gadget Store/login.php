...
session_start();
	...
	$admin1 = "asibur@gmail.com";
	$admin2 = "fahim@gmail.com";
	$admin3 = "nisarga@gmail.com";
	$admin4 = "arman@gmail.com";
	$admin5 = "mashfiq@gmail.com";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="iphone.php" style="color: gray;">Phone</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"  href="macbook.php">Laptop</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="airpods.php">TWS</a>
                    </li>
                    <li class="nav-item">
