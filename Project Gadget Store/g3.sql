...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2022 at 11:27 PM
...
('\"image/ipads/ipad.gif\"', 20, '10.2-inch (diagonal) LED-backlit Multi-Touch display with IPS technology', 'A13 Bionic chip with 64-bit architecture', '8MP Wide camera, ƒ/2.4 aperture', 'Stereo speakers', 'Touch ID', '64GB - 256GB', 'Silver - Space Grey'),
('\"image/ipads/ipad-air.gif\"', 21, '10.9-inch (diagonal) LED‑backlit Multi‑Touch display with IPS technology', 'A14 Bionic chip with 64‑bit architecture', '12MP Wide camera, ƒ/1.8 aperture', 'Stereo speakers', 'Face ID', '64GB - 256GB', 'Space gray - Sky Blue'),
...
INSERT INTO `temp` (`pid`, `model`, `price`, `subprice`, `quantity`, `email`, `SI`) VALUES
(-1, NULL, NULL, NULL, NULL, 'customer@gmail.com', 89);
...
--
ALTER TABLE `temp`
  MODIFY `SI` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
